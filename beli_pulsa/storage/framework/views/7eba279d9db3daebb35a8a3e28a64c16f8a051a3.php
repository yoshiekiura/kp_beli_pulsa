        ...
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-success">
            ...
            <ul class="navbar-nav ml-auto mr-0 mr-md-3 my-2 my-md-0">
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" id="userDropdown" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fas fa-user fa-fw"></i><?php echo e(Session::get('admin')); ?></a>
                    ...
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav"><a class="nav-link" href="TransaksiPembelian">Transaksi Pembelian</a><a class="nav-link" href="#">Proses Pembelian Pelanggan</a></nav>
                            </div>
...
<?php /**PATH M:\kp_beli_pulsa\beli_pulsa\resources\views/layout/admin.blade.php ENDPATH**/ ?>